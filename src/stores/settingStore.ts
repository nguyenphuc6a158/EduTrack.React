...
import { StorageEnum, ThemeColorPresets, ThemeLayout, ThemeMode } from 'src/lib/enumconst';
    ...
    persist(
        (set) => ({
            settings: {
                ...
                multiTab: true,
                darkSidebar: false,
                fontFamily: AppConsts.fontFamily.primary,
                fontSize: Number(AppConsts.fontSize.sm),
                direction: 'ltr',
            },
            actions: {
