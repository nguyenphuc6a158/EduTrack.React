...
(function () {
    ...
    abp.multiTenancy.tenantIdCookieName = 'evn_tenantId';
    ...
    abp.auth.isGrantedByPrefix = function (prefix) {
        return Object.keys(abp.auth.grantedPermissions)
    ...
    abp.auth.tokenCookieName = 'evn_auth_token';
